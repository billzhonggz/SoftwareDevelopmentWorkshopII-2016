    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Course Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <%--TODO: Add JSP expressions to search DB according to Course_ID.--%>
                                </tbody>
                            </table>
                        </div>
                        <!-- /.panel-body -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            CILO Alignment in Examination
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <p>Coverage of different CILOs in the examination and students' achievement</p>
                            <%--/.Pie Chart:col-lo-12--%>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <%--TODO: Add box plot here.--%>
                                    <p>Box Plot Here.</p>
                                </div>
                            </div>
                            <br>
                            <p>Coverage of different cognitive levels in the examination and students' achievement</p>
                            <%--/.Pie Chart:col-lo-12--%>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <%--TODO: Add pie chart here.--%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <%--/.Pie Chart col-log-12--%>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <p>Coverage of different CILOs in course work</p>
                                    <%--TODO: Insert pie chart here.--%>
                                    <p>Pie Chart Here</p>
                                </div>
                                <div class="panel panel-default">
                                    <p>Students' Achievement on Different CILOs</p>
                                    <%--TODO: Insert box plot here.--%>
                                    <p>Box Plot Here</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Overall Achievement on Different CILOs in the Entire Course
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <%--/.Pie Chart:col-lo-12--%>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <p>Overall coverage of different CILOs</p>
                                    <%--TODO: Add pie chart here.--%>
                                    <p>Pie Chart Here</p>
                                </div>
                            </div>
