...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="contact.html">Bill</a>
                                </li>
                                <li>
                                    <a href="contact.html">David</a>
                                </li>
                                  <li>
                                    <a href="contact.html">Frank</a>
                                </li>
                                  <li>
                                    <a href="contact.html">ZhouHL</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h1 class="text-muted">Students' info</h1>
                </div>
                <div class="col-lg-12">
                ...
                <a href=StudentsinfoN.html><button type="button" class="btn btn-outline btn-danger">Change Info</button></a>
