...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
            <h1 class="text-muted">Please Contact Us</h1>
                </div>
                <br>

                <div>
                    <i class="fa fa-envelope fa-fw"></i><i class="fa fa-caret-down">Ourmail:XXXXXXX@163.mail</i>
                ...
                <br>
                <div>
                    <i class="fa fa-mobile-phone fa-fw"></i><i class="fa fa-caret-down">OurPhone:135XXXXXXX</i>
                </div>
                <div>
