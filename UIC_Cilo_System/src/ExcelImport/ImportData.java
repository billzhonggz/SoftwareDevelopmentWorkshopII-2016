...
import ExcelImport.ReadWriteExcel;
                ...
                if (item.isFormField()) {
                    ...
                    if (item.getName() != null && !item.getName().equals("")) {
                        ...
                        if (flag == false) {
                            ...
                            RequestDispatcher rd = request.getRequestDispatcher("pages/importData.jsp");
                            ...
                            RequestDispatcher rd = request.getRequestDispatcher("pages/resultData.jsp");
